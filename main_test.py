...
def main(_):
    ...
    if rest_lapt:
        ...
        run_CLRH(source_domain="restaurant", target_domain="laptop", year_source=2014, year_target=2014,
                learning_rate_dis=0.0001, learning_rate_f=0.0001, keep_prob=0.5, momentum_dis=0.85, momentum_f=0.85,
                l2_dis=0.001, l2_f=0.001, balance_lambda=0.9, write_result=write_result)
...
def run_CLRH(source_domain, target_domain, year_source, year_target, learning_rate_dis, learning_rate_f, keep_prob,
            momentum_dis, momentum_f, l2_dis, l2_f, balance_lambda, write_result):
    """
    Run CLRH++ model.
